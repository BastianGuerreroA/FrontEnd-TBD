        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" v-on:click="editar(idUser)">Editar perfil</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="javascrip:void(0);" v-on:click="cerrarSesion();">Cerrar sesión</a></li>
            </ul>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page"><router-link :to="map">Mapa</router-link></a>
          </li>
        </ul>
...
export default {
  ...
  mounted() {
    ...
    this.map = "/coordinador/" + localStorage.getItem("id") + "/map";
  },
  methods:{
    cerrarSesion(){
      localStorage.clear();
